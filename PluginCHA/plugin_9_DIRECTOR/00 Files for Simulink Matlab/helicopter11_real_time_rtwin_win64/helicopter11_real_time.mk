...
MODEL                := helicopter11_real_time
MODULES              := helicopter11_real_time_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := helicopter11_real_time.mk
...
#
MODELLIB                  := helicopter11_real_timelib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := helicopter11_real_time_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/X-PLAN~1/RESOUR~1/plugins/PLUGIN~2/PLUGIN~2/00FILE~1/helicopter11_real_time_rtwin_win64;C:/X-PLAN~1/RESOUR~1/plugins/PLUGIN~2/PLUGIN~2/00FILE~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
